    ...
    <section id="menu" class="bg-no-repeat bg-[right_top_15rem] md:bg-right-top pt-8 md:pt-32 w-full" style="background-image: url(<?php echo e($foodBg); ?>)">
      <div class="flex flex-col justify-around items-center food-sm:items-start max-w-[980px] mx-auto">
        ...
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">
            <span class="text-amber-400 leading-snug">Kami Melayani</span> <br /><span class="leading-normal">Makan Enak</span>
          </h3>
          <p class="pt-4 text-[14px] font-sans-lato text-slate-600 leading-relaxed">Temukan Hidangan Terbaik Kami. Perjalanan rasa dimulai di sini.
          </p>
        </div>
    ...
    <!-- Food Area End -->
<?php /**PATH D:\xampp8.1\htdocs\restaurant\resources\views/home/partials/food.blade.php ENDPATH**/ ?>