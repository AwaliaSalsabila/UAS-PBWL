  ...
  <section id="book" class="py-32 px-4 md:px-32 bg-no-repeat bg-center bg-cover w-full relative z-1 text-center" style="background-image: url(<?php echo e($tableBg); ?>)">
    ...
    <div class="m-4 max-w-md mt-5 p-4 text-center text-white mx-auto">
      <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Book <span class="text-amber-400 leading-snug">meja</span> mu</h3>
  ...
  <!-- Table Area End --><?php /**PATH D:\xampp8.1\htdocs\restaurant\resources\views/home/partials/table.blade.php ENDPATH**/ ?>