    ...
    <section id="testimonial" class="bg-[url(assets/images/testimonial-bg.jpg')] bg-center bg-cover bg-no-repeat mt-28 px-10 py-24 relative w-full z-1">
      ...
      <div class="m-4 max-w-md mt-5 p-4 text-center text-white mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Customer <span class="text-amber-400 leading-snug">mengatakan</span> . . .</h3>
    ...
    <!-- Testimonial Area End --><?php /**PATH D:\xampp8.1\htdocs\restaurant\resources\views/home/partials/testimonial.blade.php ENDPATH**/ ?>