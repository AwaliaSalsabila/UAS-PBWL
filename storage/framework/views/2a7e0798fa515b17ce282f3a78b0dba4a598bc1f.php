    ...
    <section class="py-32 mx-auto max-w-[960px]">
      <div class="m-4 max-w-md mt-5 mb-11 p-4 text-center mx-auto">
        <h3 class="font-bold font-cursive-merie text-4xl leading-normal capitalize">Menu <span class="text-amber-400 leading-snug">spesial</span> kami</h3>
        <p class="pt-2 text-[14px] font-sans-lato text-slate-600 leading-relaxed">Nikmati berbagai masakan khas dengan cita rasa luar biasa. Setiap hidangan kami disajikan dengan bahan segar dan cinta.</p>
      </div>
    ...
    <!-- Deshes Area End --><?php /**PATH D:\xampp8.1\htdocs\restaurant\resources\views/home/partials/deshes.blade.php ENDPATH**/ ?>